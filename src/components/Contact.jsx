    ...
    <section id="contact" className="relative py-24 lg:py-32" ref={ref}>
      <div className="max-w-6xl mx-auto px-6">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p
            className={`text-text-secondary mt-6 leading-relaxed transition-all duration-600 delay-200 ${
              inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"
            }`}
          >
            I'm actively looking for software developer roles across Canada. If
            you're hiring, have a question, or just want to say hello, I'd love
            to hear from you.
          </p>

          {/* Contact links */}
          <div
            className={`flex flex-col sm:flex-row items-center justify-center gap-4 mt-8 transition-all duration-600 delay-300 ${
              inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"
            }`}
          >
            <a
          ...
          {/* Social links */}
          <div
            className={`flex items-center justify-center gap-6 mt-8 transition-all duration-600 delay-[400ms] ${
              inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"
            }`}
          >
            <a
